      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#262626] hover:bg-[#FFD700] hover:text-black rounded-full flex items-center justify-center transition-colors" data-testid="footer-facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#262626] hover:bg-[#FFD700] hover:text-black rounded-full flex items-center justify-center transition-colors" data-testid="footer-instagram">
            ...
            <a href="/admin" className="w-10 h-10 bg-[#262626] hover:bg-[#FFD700] hover:text-black rounded-full flex items-center justify-center transition-colors" data-testid="footer-admin">
...
function FloatingCTA() {
  return (
    <div className="fixed bottom-6 left-4 right-4 z-50 md:hidden" data-testid="floating-cta">
      <a href={PHONE_LINK}>
        <Button className="floating-cta w-full bg-[#FFD700] hover:bg-[#FFC107] text-black text-lg py-6 rounded-full gap-2 font-bold shadow-xl">
